// This is straight-up copy/pasted from the reqwest test library.
// Rather than trying to write my own version, here is this neatly done
// test server that I need for one of my tests
